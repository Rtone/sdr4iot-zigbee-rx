...
# Title: zigbee_simulation
# Author: Ousseynou FALL
# Generated: Sun Jun 28 23:15:49 2020
##################################################
...
class zigbee_demod_fsk(gr.top_block, Qt.QWidget):
...
def main(top_block_cls=zigbee_demod_fsk, options=None):
