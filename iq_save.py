...
def iq_save(csv_file, iq_file):
    ...
    """
    data_file_sigmfdata = iq_file.split('.')[0]+'-zigbee_IQ.sigmf-data'
    ...
    print('Run sigmf_recording.py with extracted ZIGBEE data file to get a sigmf archive')
...
if __name__ == '__main__':
    ...
    parser.add_option("-d", "--data-file", type="string", default='',
                      help="IQ file path to be used to extract ZIGBEE IQ data")
